...
#define MRVDRV_NUM_OF_CMD_BUFFER       20// 4	//20
/** Size of command buffer */
#define MRVDRV_SIZE_OF_CMD_BUFFER       (/*2 * */1024)

/** Maximum number of BSS Descriptors */
#define MRVDRV_MAX_BSSID_LIST           2//64
...
typedef struct _ChanBandParamSet_t
{
    ...
    /** Channel number */
    t_u8 chan_number;
}MLAN_PACK_END ChanBandParamSet_t;
