...
typedef unsigned char		YJ_U8;
typedef unsigned short		YJ_U16;
typedef unsigned int		YJ_U32;
typedef signed char			YJ_S8;
typedef signed short		YJ_S16;
typedef signed int 			YJ_S32;

typedef enum
{
	YJ_FALSE = 0, YJ_TRUE = !YJ_FALSE
}YJ_BOOL;
